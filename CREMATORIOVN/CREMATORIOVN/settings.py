"""
Django settings for CREMATORIOVN project.
...
SECRET_KEY = 'django-insecure-28oq1bgt3d)&tw40t4jgap^^jrtgx=_bexzwtany6x^i_19e*3'
...
ROOT_URLCONF = 'CREMATORIOVN.urls'
...
WSGI_APPLICATION = 'CREMATORIOVN.wsgi.application'
